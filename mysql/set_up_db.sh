...
service mysql start
ufw allow 3306
mysql -uroot -e "CREATE SCHEMA AirLuxDB character set utf8mb4 collate utf8mb4_bin; CREATE TABLE AirLuxDB.captors (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, client_id VARCHAR(255) NOT NULL, value VARCHAR(255), updated_at DATE, created_at DATE, UNIQUE INDEX id_UNIQUE (uid ASC));"
